...
function datosContactos(json) {
  for (i = 0; i < json.length; i++) {
    ...
    contacto.style.backgroundColor = "#dcdcdc";
    contacto.style.borderRadius = "15px";
    paisRegion.style.backgroundColor = "#dcdcdc";
    paisRegion.style.borderRadius = "15px";
    compania.style.backgroundColor = "#dcdcdc";
    compania.style.borderRadius = "15px";
    cargo.style.backgroundColor = "#dcdcdc";
    cargo.style.borderRadius = "15px";
    interes.style.backgroundColor = "#dcdcdc";
    interes.style.borderRadius = "15px";
    accion.style.backgroundColor = "#dcdcdc";
    accion.style.borderRadius = "15px";
    ...
    square.addEventListener("click", function () {
      square.style.backgroundColor = "#53e3a6";
...
function deleteContact(id_contact) {
  ...
  fetch(urlContactos, requestOptions)
    .then((res) => res.json())
    .then((json) => {
      if (json.msj == "Contacto eliminado exitosamente") {
        cargarContactos();
