  ...
  fetch(urlCompanias, requestOptions)
    ...
    .then((json) => {
      ...
      for (i = 0; i < json.length; i++) {
        ...
        nombre.style.backgroundColor = "#dcdcdc";
        nombre.style.borderRadius = "15px";
        direccion.style.backgroundColor = "#dcdcdc";
        direccion.style.borderRadius = "15px";
        email.style.backgroundColor = "#dcdcdc";
        email.style.borderRadius = "15px";
        ciudad.style.backgroundColor = "#dcdcdc";
        ciudad.style.borderRadius = "15px";
...
function postCompany() {
  ...
  const urlCompanie = "http://localhost:3500/companies";
  fetch(urlCompanie, requestOptions)
    .then((res) => res.json())
    .then((json) => {
      //console.log(json);
...
function patchCompany(id_company) {
  ...
  const urlCompanie = `http://localhost:3500/companies/${id_company}`;
  fetch(urlCompanie, requestOptions)
    .then((res) => res.json())
    .then((json) => {
...
function deleteCompany(id_company) {
  ...
  fetch(urlCompanie, requestOptions)
    .then((res) => res.json())
    .then((json) => {
      if (json.msj == "Compañia eliminada exitosamente") {
        cargarCompanias();
